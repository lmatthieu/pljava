/*
 * Copyright (c) 2004, 2005, 2006 TADA AB - Taby Sweden Copyright (c) 2010, 2011
 ...
 * translated into the corresponding call with index position computed using a
 * call to {@link java.sql.ResultSet#findColumn(String) findColumn}.
 * 
...
public abstract class AbstractResultSet implements ResultSet
{
  ...
  /**
   * Added to support Java 7 ResultSet interface
   */
  public <T> T getObject( int columnIndex, Class<T> type ) throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".getObject( int columnIndex, Class<T> type ) not implemented yet.",
        "0A000" );
  }
  /**
   * Added to support Java 7 ResultSet interface
      ...
      throws SQLException
  {
    throw new SQLFeatureNotSupportedException(
        this.getClass()
            + ".getObject( String columnLabel, Class<T> type ) not implemented yet.",
        "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNClob( int, NClob ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNClob( String, NClob ) not implemented yet.", "0A000" );
  }

  public void updateNClob( int columnIndex, Reader reader ) throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNClob( int, Reader ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNClob( int, Reader, long ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNClob( String, Reader ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNClob( String, Reader, long ) not implemented yet.", "0A000" );
  }

  public void updateClob( int columnIndex, Reader reader ) throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateClob( int, Reader ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateClob( int, Reader, long ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateClob( String, Reader ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateClob( String, Reader, long ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateBlob( int, InputStream ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateBlob( int, InputStream, long ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateBlob( String, InputStream ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateCharacterStream( int, Reader ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateAsciiStream( String, InputStream ) not implemented yet.",
        "0A000" );
  }
      ...
      throws SQLException
  {
    throw new SQLFeatureNotSupportedException(
        this.getClass()
            + ".updateAsciiStream( String, InputStream, long ) not implemented yet.",
        "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".getNCharacterStream( String ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".getNString( String ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateSQLXML( int, SQLXML ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateSQLXML( String, SQLXML ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNString( String, String ) not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateNString( String, Object[] ) not implemented yet.", "0A000" );
  }

  public void updateRowId( int columnIndex, RowId x ) throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateRowId( int, RowId ) not implemented yet.", "0A000" );
  }

  public void updateRowId( String columnLabel, RowId x ) throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".updateRowId( String, RowId ) not implemented yet.", "0A000" );
  }
