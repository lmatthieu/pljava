/*
 * Copyright (c) 2004, 2005, 2006 TADA AB - Taby Sweden Distributed under the
 * terms shown in the file COPYRIGHT found in the root folder of this project or
 * at http://eng.tada.se/osprojects/COPYRIGHT.html
 */
...
public class SPIDriver implements Driver
{
  ...
  private static final int                  s_defaultURLLen = s_defaultURL
                                                                .length();
  ...
  /**
   * Added to support Java 7 Driver interface
   */
  public Logger getParentLogger() throws SQLFeatureNotSupportedException
  {
    throw new SQLFeatureNotSupportedException(
        "Driver.getParentLogger() not implemented yet.", "0A000" );
  }
