/*
 * Copyright (c) 2004, 2005, 2006 TADA AB - Taby Sweden Copyright (c) 2008,
...
public class SPIStatement implements Statement
{
  ...
  /**
   * Added to support Java 7 Statement interface
   */
  public void closeOnCompletion() throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".closeOnCompletion() not implemented yet.", "0A000" );
  }
   ...
   * 
   * @throws SQLException
   *           indicating that this feature is not supported for other values on
   *           <code>direction</code>.
   */
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".setPoolable( boolean ) not implemented yet.", "0A000" );
  }

  public boolean isPoolable() throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".isPoolable() not implemented yet.", "0A000" );
  }

  public boolean isClosed() throws SQLException
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".isClosed() not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".isCloseOnCompletion() not implemented yet.", "0A000" );
  }
  ...
  {
    throw new SQLFeatureNotSupportedException( this.getClass()
        + ".unwrapClass( Class<T> ) not implemented yet.", "0A000" );
  }
}
